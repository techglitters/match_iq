...
class GameConstants {
  ...
  static const Map<String, Color> relationshipColors = {
    ...
    'nest_to_bird': Color(0xFFFF6D00),
    'moon_to_night': Color(0xFF808000),
    'mountain_to_snow': Color(0xFF4363D8),
    'wind_to_leaf': Color(0xFFFDD835),
    'garden_to_flower': Color(0xFF8E24AA),
    'mountain_to_river': Color(0xFF0097A7),
    'leaf_to_soil': Color(0xFF9A6324),
    'bird_to_nest': Color(0xFF1B5E20),
    'snow_to_mountain': Color(0xFF4363D8),
    'fire_to_smoke': Color(0xFFD50000),
